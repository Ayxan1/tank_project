...
class Tank():
    ...
    def check_free_angle_for_moving_backward(self):
        ...
        if self.angle <= 0:
            ...
            angle = 360 - angle
        print('___________BACKWARD_______________')
        print('angle --- ', angle)
    ...
    def update(self):
        ...
        if self.moving_backward:
            ...
            if self.angle == 0 or self.angle == 360 or self.angle == -360 or self.angle == 180 or self.angle == -180 :
                ...
                print('collisions right_wall_collision ', self.back_right_wall_collision)
                print('collisions left_wall_collision ', self.back_left_wall_collision)
                print('collisions top_wall_collision ', self.back_top_wall_collision)
                print('collisions bottom_wall_collision ', self.back_bottom_wall_collision)
